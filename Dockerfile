...
ARG PACKAGIST_NAME="jakub-onderka/php-parallel-lint"
ARG PHPQA_NAME="php-parallel-lint"
ARG VERSION="1.0.0"
...
# Install PHP Parallel Lint - https://github.com/JakubOnderka/PHP-Parallel-Lint
